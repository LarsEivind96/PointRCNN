...
# idx should be the filename
class BumpDataset(torch_data.Dataset):
    ...
    # Think calibration is to convert 2d boxes from 3d and vice versa (the relation between camera pixels and coordinates)
    ...
    # This will not be used, as We don't have normals.
